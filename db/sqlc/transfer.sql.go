...
func (q *Queries) GetTransferFromAccount(ctx context.Context, arg GetTransferFromAccountParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransferFromAccount, arg.FromAccountID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTransferToAccount(ctx context.Context, arg GetTransferToAccountParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransferToAccount, arg.ToAccountID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
